...
export const appRoutes: Routes = [
  ...
  { path: 'events/:id', component: EventDetailsComponent, resolve: {event: EventsResolver} }, // for canActiviate and canDeactivate can use Service (like we did here) or method like above
